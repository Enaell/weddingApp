	...
	[
		{
			...
			location: 'Beijing',
			type: 'city',
			date: (new Date(2018, 7, 11, 10)).toISOString(),
		...
		},
		{
			...
			location: 'Beijing',
			type: 'monument',
			date: (new Date(2018, 7, 11, 14)).toISOString(),
		...
		},
		{
			...
			location: 'Beijing',
			type: 'optionalVisit',
			date: (new Date(2018, 7, 11, 16)).toISOString(),
		...
		},
		{
			...
			location: 'Beijing',
			type: 'monument',
			date: (new Date(2018, 7, 12, 9)).toISOString(),
			duration: 3,
		...
		},
		{
			...
			location: 'Beijing',
			type: 'monument',
			date: (new Date(2018, 7, 12, 14)).toISOString(),
			duration: 3,
		...
		},
		{
			...
			location: 'Beijing',
			type: 'show',
			date: (new Date(2018, 7, 12, 20)).toISOString(),
			duration: 2,
		...
		},
		{
			...
			location: 'Beijing',
			type: 'monument',
			date: (new Date(2018, 7, 13, 9)).toISOString(),
			duration: 2,
		...
		},
		{
			...
			location: 'Beijing',
			type: 'monument',
			date: (new Date(2018, 7, 13, 14)).toISOString(),
			duration: 3,
		...
		},
		{
			...
			location: 'Beijing',
			type: 'show',
			date: (new Date(2018, 7, 13, 20)).toISOString(),
			duration: 2,
			description: 'Spectacle',
			xcoordinate: '2345',
			ycoordinate: '423546',
		...
		},
		{
			...
			location: 'Beijing',
			type: 'monument',
			date: (new Date(2018, 7, 14, 10)).toISOString(),
			duration: 6,
			description: 'La Grande Muraille1 (chinois simplifié : 长城 ; chinois traditionnel : 長城 ; pinyin : Chángchéng ; Wade : Ch\'ang²ch\'eng² ; littéralement « la longue muraille »), aussi appelé « Les Grandes Murailles » est un ensemble de fortifications militaires chinoises construites, détruites et reconstruites en plusieurs fois et à plusieurs endroits entre le IIIe siècle av. J.-C. et le XVIIe siècle pour marquer et défendre la frontière nord de la Chine. C\'est la structure architecturale la plus importante jamais construite par l’Homme à la fois en longueur, en surface et en masse.',
			xcoordinate: '2345',
			ycoordinate: '423546',
		...
		},
		{
			...
			location: 'Beijing',
			type: 'transport',
			date: (new Date(2018, 7, 14, 19)).toISOString(),
			duration: 5,
		...
		},
		{
			...
			location: 'Xi\'An',
			type: 'city',
			date: (new Date(2018, 7, 15, 8)).toISOString(),
			duration: 48,
		...
		},
		{
			...
			location: 'Xi\'An',
			type: 'monument',
			date: (new Date(2018, 7, 15, 10)).toISOString(),
			duration: 5,
			description: 'Xi\'an (chinois: 西安 ; pinyin : Xī\'ān ; littéralement : « paix de l\'Ouest » ; EFEO Si- ngan - fou) est la capitale de la province du Shaanxi en Chine.Elle a le statut de ville sous- provinciale.Cette ville, qui a une histoire de plus de 3 100 ans, a été la capitale de la Chine et se nommait alors Chang\'an. L\'actuelle Xi\'an se classe dans les dix plus grandes villes chinoises. Elle compte plus de huit millions d\'habitants enregistrés.',
			xcoordinate: '654',
			ycoordinate: '45',
		...
		},
		{
			...
			location: 'Xi\'An',
			type: 'monument',
			date: (new Date(2018, 7, 15, 17)).toISOString(),
			duration: 2,
		...
		},
		{
			...
			location: 'Xi\'An',
			type: 'monument',
			date: (new Date(2018, 7, 16, 9)).toISOString(),
			duration: 2,
		...
		},
		{
			...
			location: 'Xi\'An',
			type: 'transport',
			date: (new Date(2018, 7, 16, 13)).toISOString(),
			duration: 5,
		...
		},
		{
			...
			location: 'NanJing',
			type: 'city',
			date: (new Date(2018, 7, 16, 18)).toISOString(),
			duration: 20,
		...
		},
		{
			...
			location: 'NanJing',
			type: 'optionalVisit',
			date: (new Date(2018, 7, 16, 20)).toISOString(),
			duration: 5,
		...
		},
		{
			...
			location: 'NanJing',
			type: 'monument',
			date: (new Date(2018, 7, 17, 10)).toISOString(),
			duration: 2,
		...
		},
		{
			...
			location: 'DongTai',
			type: 'transport',
			date: (new Date(2018, 7, 17, 14)).toISOString(),
			duration: 3,
		...
		},
		{
			...
			location: 'DongTai',
			type: 'city',
			date: (new Date(2018, 7, 17, 17)).toISOString(),
			duration: 2,
		...
		},
		{
			...
			location: 'DongTai',
			type: 'dinner',
			date: (new Date(2018, 7, 17, 18)).toISOString(),
			duration: 2,
		...
		},
		{
			...
			location: 'DongTai',
			type: 'wedding',
			date: (new Date(2018, 7, 18, 10)).toISOString(),
			duration: 14,
			description: 'divers activité, ceremonie et repas de Marriage',
			xcoordinate: '0498',
			ycoordinate: '23458',
			imageUrl: ''
		},
		{
			...
			location: 'DongTai',
			type: 'transport',
			date: (new Date(2018, 7, 19, 11)).toISOString(),
			duration: 2,
		...
		},
		{
			...
			location: 'WuXi',
			type: 'city',
			date: (new Date(2018, 7, 19, 13)).toISOString(),
			duration: 2,
		...
		},
		{
			...
			location: 'WuXi',
			type: 'monument',
			date: (new Date(2018, 7, 19, 15)).toISOString(),
			duration: 2,
		...
		},
		{
			...
			location: 'WuXi',
			type: 'optionalVisit',
			date: (new Date(2018, 7, 19, 19)).toISOString(),
			duration: 4,
		...
		},
		{
			...
			location: 'WuXi',
			type: 'monument',
			date: (new Date(2018, 7, 20, 9)).toISOString(),
			duration: 2,
		...
		},
		{
			...
			location: 'WuXi',
			type: 'monument',
			date: (new Date(2018, 7, 20, 13)).toISOString(),
			duration: 3,
		...
		},
		{
			...
			location: 'Wuxi',
			type: 'transport',
			date: (new Date(2018, 7, 21, 9)).toISOString(),
			duration: 2,
		...
		},
		{
			...
			location: 'HuangShan',
			type: 'city',
			date: (new Date(2018, 7, 21, 12)).toISOString(),
			duration: 2,
		...
		},
		{
			...
			location: 'HuangShan',
			type: 'monument',
			date: (new Date(2018, 7, 21, 13)).toISOString(),
			duration: 3,
			description: 'Visite d\'un vieux village aux abord de WuXi',
			xcoordinate: '0498',
			ycoordinate: '23458',
		...
		},
		{
			...
			location: 'HuangShan',
			type: 'monument',
			date: (new Date(2018, 7, 22, 8)).toISOString(),
			duration: 8,
		...
		},
		{
			...
			location: 'HuangShan',
			type: 'monument',
			date: (new Date(2018, 7, 23, 9)).toISOString(),
			duration: 3,
			description: 'Huangshan ou monts Jaunes (sinogrammes simplifiés 黄山  ; hanyu pinyin huángshān, littéralement « la montagne jaune ») sont un massif montagneux de l\'Anhui méridional, province de l\'est de la Chine. La région est connue pour sa beauté, qui repose sur la forme des pics de granite, sur celle tourmentée des conifères, et sur les nuages qui entourent fréquemment le massif. Cette montagne mythique change sans cesse de visage au gré des vents et des bruines... désespérant parfois les artistes qui désirent en fixer la beauté',
			xcoordinate: '349078',
			ycoordinate: '90345',
		...
		},
		{
			...
			location: 'HuangShan',
			type: 'transport',
			date: (new Date(2018, 7, 23, 13)).toISOString(),
			duration: 3,
		...
		},
		{
			...
			location: 'Shanghai',
			type: 'city',
			date: (new Date(2018, 7, 23, 17)).toISOString(),
			duration: 48,
		...
		},
		{
			...
			location: 'Shanghai',
			type: 'optionalVisit',
			date: (new Date(2018, 7, 23, 19)).toISOString(),
			duration: 2,
		...
		},
		{
			...
			location: 'Shanghai',
			type: 'monument',
			date: (new Date(2018, 7, 24, 10)).toISOString(),
			duration: 2,
		...
		},
		{
			...
			location: 'Shanghai',
			type: 'monument',
			date: (new Date(2018, 7, 24, 13)).toISOString(),
			duration: 4,
		...
		},
		{
			...
			location: 'Shanghai',
			type: 'monument',
			date: (new Date(2018, 7, 24, 17)).toISOString(),
			duration: 1,
